...
export const Nav = () => {
    ...
    return (
        <motion.nav
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="bg-[rgba(19,19,19,0.79)] py-3 px-5 border-b border-b-accent sticky top-0 w-full z-10 backdrop-blur-sm flex items-center justify-between flex-wrap"
        >
            <NavLogo />
